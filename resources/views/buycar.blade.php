...
<style>
    ...
    .buy-btn:hover { background: #0b5ed7; color: white; }
</style>
    ...
    <div class="row">
        ...
        <div class="col-md-3 sidebar">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <a href="/buycar" style="font-size:12px; color:#dc3545; text-decoration:none;">✕ Reset</a>
            </div>

            <div class="row g-2">
                <div class="col-6">
                    <a href="/buycar?category=SUV" class="filter-btn {{ request('category') == 'SUV' ? 'active' : '' }}">SUV</a>
                </div>
                <div class="col-6">
                    <a href="/buycar?category=Sedan" class="filter-btn {{ request('category') == 'Sedan' ? 'active' : '' }}">Sedan</a>
                </div>
                <div class="col-6">
                    <a href="/buycar?category=Touring" class="filter-btn {{ request('category') == 'Touring' ? 'active' : '' }}">Touring</a>
                </div>
                <div class="col-6">
                    <a href="/buycar?category=Coupe" class="filter-btn {{ request('category') == 'Coupe' ? 'active' : '' }}">Coupe</a>
                </div>
                <div class="col-6">
                    <a href="/buycar?category=Convertible" class="filter-btn {{ request('category') == 'Convertible' ? 'active' : '' }}">Convertible</a>
                </div>
            </div>
            ...
            <div class="row g-2">
                <div class="col-6">
                    <a href="/buycar?drivetrain=Electric" class="filter-btn {{ request('drivetrain') == 'Electric' ? 'active' : '' }}">100% Electric</a>
                </div>
                <div class="col-6">
                    <a href="/buycar?drivetrain=Plug-in Hybrid" class="filter-btn {{ request('drivetrain') == 'Plug-in Hybrid' ? 'active' : '' }}">Plug-in Hybrid</a>
                </div>
                <div class="col-6">
                    <a href="/buycar?drivetrain=Petrol" class="filter-btn {{ request('drivetrain') == 'Petrol' ? 'active' : '' }}">Petrol</a>
                </div>
            </div>
...
<!-- 
            ...
            @if(request('category') || request('series') || request('drivetrain'))
                <div style="margin-bottom:16px; font-size:13px; color:#666;">
                    ...
                    <a href="/buycar" style="color:#dc3545; margin-left:10px; font-size:12px;">✕ Reset</a>
                </div>
            @endif -->
            ...
            <div class="row g-4 mt-2">
                ...
                <div class="col-12 text-center py-5">
                    ...
                    <a href="/buycar" style="color:#0d6efd;">Lihat semua model</a>
                </div>
                @endforelse
            </div>
