...
<div class="right">
  ...
  <a href="/brochure/m3" class="btn-bro">
...
let currentImages = [
  "{{ asset('images/3white1.png') }}",
  "{{ asset('images/3white2.png') }}",
  "{{ asset('images/3white3.png') }}"
];
...
function changeCar(color){
    ...
    if(color === 'black'){
        ...
        currentImages = [
          "{{ asset('images/3black1.png') }}",
          "{{ asset('images/3black2.png') }}",
          "{{ asset('images/3black3.png') }}"
        ];
    ...
    if(color === 'blue'){
        ...
        currentImages = [
          "{{ asset('images/3blue1.png') }}",
          "{{ asset('images/3blue2.png') }}",
          "{{ asset('images/3blue3.png') }}"
        ];
