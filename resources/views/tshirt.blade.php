...
<div class="detail-wrap">
    ...
    <div class="detail-grid">
        <div>
            <img id="mainImg" class="img-main" src="https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?w=800" alt="T-Shirt">
            <div class="thumb-row" id="thumbRow"></div>
        </div>
        <div>
            <span class="badge-cat">Clothing</span>
            <h1 class="prod-name">T-Shirt</h1>
            <p class="prod-desc">Kaos oversized modern dengan bahan 100% cotton premium yang nyaman dan breathable. Pilihan warna yang stylish untuk tampilan kasual.</p>
            <div class="prod-price">50.000</div>
            <div class="spec-box">
                <div class="spec-row"><span>Brand</span><span>BMW Lifestyle</span></div>
                <div class="spec-row"><span>Material</span><span>100% Cotton</span></div>
            ...
            <a href="/beli?model=T-Shirt&harga=50.000&skip=1" class="btn-beli">Beli Sekarang</a>
        </div>
    </div>
</div>
