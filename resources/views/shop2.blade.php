...
<section class="booking-section">
    ...
    <div class="booking-left">
        ...
        <div class="thumb-gallery">
            <img class="thumb active"src="{{ asset('images/ix13.png') }}"onclick="changeImage(0)">
            <img class="thumb"src="{{ asset('images/ix11.png') }}"onclick="changeImage(1)">
            <img class="thumb"src="{{ asset('images/ix12.png') }}"onclick="changeImage(2)">
    ...
    <div class="booking-right">
        ...
        <a href="#" class="book-btn" onclick="window.location.href='/beli?model=BMW+ix1&harga=Rp+935.000.000'">
            Buy Now
        </a>
...
const images = [
    "{{ asset('images/ix13.png') }}",
    "{{ asset('images/ix11.png') }}",
    "{{ asset('images/ix12.png') }}",
