...
function changeCar(color){
    ...
    if(color === 'black'){
        ...
        currentImages = [
          "{{ asset('images/7black1.png') }}",
          "{{ asset('images/7black2.png') }}",
          "{{ asset('images/7black3.png') }}"
        ];
    ...
    if(color === 'grey'){
        ...
        currentImages = [
          "{{ asset('images/7grey1.png') }}",
          "{{ asset('images/7grey2.png') }}",
          "{{ asset('images/7grey3.png') }}"
        ];
