    ...
    <div id="chat-popup">
        <div class="chat-header">
            ...
            <button onclick="resetChat()"
                style="background:none;border:none;color:white;font-size:12px;">Reset</button>
        </div>

        <div id="chat-box"></div>

        <div class="chat-input-area">
            <input type="text" id="message" placeholder="Tanyakan tentang EPSILON..."
        ...
        <div class="footer-top">
            ...
            <div class="footer-col footer-social">
                ...
                <div class="social-icons">
                    <a href="#"><img width="45" height="45"
                            src="https://img.icons8.com/fluency/48/instagram-new.png" alt="instagram" /></a>
                    <a href="#"><img width="45" height="45"
                            src="https://img.icons8.com/color/48/facebook.png" alt="facebook" /></a>
                    <a href="#"><img width="45" height="45"
                            src="https://img.icons8.com/color/48/youtube-play.png" alt="youtube" /></a>
                    <a href="#"><img width="45" height="45"
            ...
            fetch('/chatbot/history')
                ...
                .then(data => {
                    if (data.history.length === 0) {
                        appendBot(
                            'Hello! Im EPSILON Assistant, your virtual guide for EPSILON. How may I assist you today? 🚗'
                        );
                        return;
                    }
