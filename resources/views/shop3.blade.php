...
<section class="booking-section">
    ...
    <div class="booking-left">
        ...
        <div class="car-viewer">
            ...
            <img id="mainCar" src="{{ asset('images/i73.png') }}" alt="">
        ...
        <div class="thumb-gallery">
            <img class="thumb active"src="{{ asset('images/i73.png') }}"onclick="changeImage(0)">
            <img class="thumb"src="{{ asset('images/i72.png') }}"onclick="changeImage(1)">
            <img class="thumb"src="{{ asset('images/i71.png') }}"onclick="changeImage(2)">
    ...
    <div class="booking-right">
        ...
        <a href="/beli?model=i7&harga=Rp+935.000.000" class="book-btn" onclick="window.location.href='/beli?model=BMW+i7&harga=Rp+1.935.000.000'">
            Buy Now
        </a>
...
const images = [
    "{{ asset('images/i73.png') }}",
    "{{ asset('images/i72.png') }}",
    "{{ asset('images/i71.png') }}",
