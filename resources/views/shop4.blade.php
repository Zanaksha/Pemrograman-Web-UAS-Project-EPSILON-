...
<section class="booking-section">
    ...
    <div class="booking-left">
        ...
        <div class="thumb-gallery">
            <img class="thumb active"src="{{ asset('images/i53.png') }}"onclick="changeImage(0)">
            <img class="thumb"src="{{ asset('images/i52.png') }}"onclick="changeImage(1)">
            <img class="thumb"src="{{ asset('images/i51.png') }}"onclick="changeImage(2)">
    ...
    <div class="booking-right">
        ...
        <a href="#" class="book-btn" onclick="window.location.href='/beli?model=BMW+i5&harga=Rp+935.000.000'">
            Buy Now
        </a>
...
const images = [
    "{{ asset('images/i53.png') }}",
    "{{ asset('images/i52.png') }}",
    "{{ asset('images/i51.png') }}",
