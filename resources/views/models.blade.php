  ...
  <div class="row g-2">
    ...
    <div class="col-md-9 p-4 mt-4">
      <div class="row g-4 mt-4" >
        <!-- Card 1 -->
        <div class="col-md-4">
          <div class="car-card" onclick="window.location.href='/ix'">
        ...
        <!-- Card 3 -->
        <div class="col-md-4">
          <div class="car-card" onclick="window.location.href='/ix1'">
        ...
        <!-- Card 1 -->
        <div class="col-md-4">
          <div class="car-card" onclick="window.location.href='/i7'">
            <span class="badge-type">SUV</span>
            <h1>i7</h1>
            <p>Model</p>
        ...
        <!-- Card 3 -->
        <div class="col-md-4">
          <div class="car-card" onclick="window.location.href='/i5'">
         ...
         <div class="col-md-4">
          <div class="car-card " onclick="window.location.href='/i4'">
         ...
         <div class="col-md-4">
          <div class="car-card" onclick="window.location.href='/xm'">
         ...
         <div class="col-md-4">
          <div class="car-card" onclick="window.location.href='/x5'">
       ...
       <div class="col-md-4">
          <div class="car-card"  onclick="window.location.href='/x3'">
          ...
          <div class="col-md-4">
          <div class="car-card"  onclick="window.location.href='/7'">
