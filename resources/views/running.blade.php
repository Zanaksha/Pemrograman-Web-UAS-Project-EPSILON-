...
<div class="detail-wrap">
    ...
    <div class="detail-grid">
        <div>
            <img id="mainImg" class="img-main" src="https://images.unsplash.com/photo-1491553895911-0055eca6402d?w=800" alt="Running Shoes">
            <div class="thumb-row" id="thumbRow"></div>
        </div>
        <div>
            <span class="badge-cat">Footwear</span>
            <h1 class="prod-name">Running Shoes</h1>
            <p class="prod-desc">Sepatu lari performa tinggi dengan teknologi cushioning terbaru. Ringan, responsif, dan nyaman untuk mendukung aktivitas olahraga intensif.</p>
            <div class="prod-price">$140</div>
            <div class="spec-box">
                <div class="spec-row"><span>Brand</span><span>BMW Sport</span></div>
                <div class="spec-row"><span>Material</span><span>Knit & EVA Foam</span></div>
            ...
            <a href="/beli?model=Running+Shoes&harga=$140&skip=1" class="btn-beli">Beli Sekarang</a>
        </div>
    </div>
</div>
...
<script>
    ...
    const ukuran = ['38','39','40','41','42','43','44'];
