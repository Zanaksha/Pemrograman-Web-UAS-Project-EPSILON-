...
function changeCar(color){
    ...
    if(color === 'black'){
        ...
        currentImages = [
          "{{ asset('images/xmblack1.png') }}",
          "{{ asset('images/xmblack2.png') }}",
          "{{ asset('images/xmblack3.png') }}"
        ];
    ...
    if(color === 'green'){
        ...
        currentImages = [
          "{{ asset('images/xmgreen1.png') }}",
          "{{ asset('images/xmgreen2.png') }}",
          "{{ asset('images/xmgreen3.png') }}"
        ];
