...
<section class="booking-section">
    ...
    <div class="booking-left">
        ...
        <div class="car-viewer">
            ...
            <img id="mainCar" src="{{ asset('images/7white1.png') }}" alt="">
        ...
        <div class="thumb-gallery">
            <img class="thumb active"src="{{ asset('images/7white1.png') }}"onclick="changeImage(0)">
            <img class="thumb"src="{{ asset('images/7white2.png') }}"onclick="changeImage(1)">
            <img class="thumb"src="{{ asset('images/7white3.png') }}"onclick="changeImage(2)">
    ...
    <div class="booking-right">
        ...
        <a href="#" class="book-btn" onclick="window.location.href='/beli?model=BMW+7&harga=Rp+935.000.000'">
            Buy Now
        </a>
...
const images = [
    "{{ asset('images/7white1.png') }}",
    "{{ asset('images/7white2.png') }}",
    "{{ asset('images/7white3.png') }}",
