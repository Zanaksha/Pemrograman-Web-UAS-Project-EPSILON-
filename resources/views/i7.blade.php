...
<div class="right">
  ...
  <a href="/brochure/i7" class="btn-bro">
...
function changeCar(color){
    ...
    if(color === 'black'){
        ...
        currentImages = [
          "{{ asset('images/i7black1.png') }}",
          "{{ asset('images/i7black2.png') }}",
          "{{ asset('images/i7black3.png') }}"
        ];
    ...
    if(color === 'red'){
        ...
        currentImages = [
          "{{ asset('images/i7red1.png') }}",
          "{{ asset('images/i7red2.png') }}",
          "{{ asset('images/i7red3.png') }}"
        ];
