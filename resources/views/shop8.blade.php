...
<section class="booking-section">
    ...
    <div class="booking-left">
        ...
        <div class="car-viewer">
            ...
            <img id="mainCar" src="{{ asset('images/x3white2.png') }}" alt="">
        ...
        <div class="thumb-gallery">
            <img class="thumb active"src="{{ asset('images/x3white1.png') }}"onclick="changeImage(0)">
            <img class="thumb"src="{{ asset('images/x3white2.png') }}"onclick="changeImage(1)">
            <img class="thumb"src="{{ asset('images/x3white3.png') }}"onclick="changeImage(2)">
    ...
    <div class="booking-right">
        ...
        <a href="#" class="book-btn" onclick="window.location.href='/beli?model=BMW+x3&harga=Rp+2.350.000.000'">
            Buy Now
        </a>
...
const images = [
    "{{ asset('images/x3white1.png') }}",
    "{{ asset('images/x3white2.png') }}",
    "{{ asset('images/x3white3.png') }}",
