...
<div class="right">
  ...
  <a href="/brochure/ix1" class="btn-bro">
...
function changeCar(color){
    ...
    if(color === 'black'){
        ...
        currentImages = [
          "{{ asset('images/ix1black1.png') }}",
          "{{ asset('images/ix1black2.png') }}",
          "{{ asset('images/ix1black3.png') }}"
        ];
    ...
    if(color === 'blue'){
        ...
        currentImages = [
          "{{ asset('images/ix1blue1.png') }}",
          "{{ asset('images/ix1blue2.png') }}",
          "{{ asset('images/ix1blue3.png') }}"
        ];
