...
<div class="left">
  <div class="image-viewer">
    ...
    <!-- GAMBAR UTAMA -->
    <img id="mainImage" src="{{ asset('images/ix3.png') }}" alt="BMW IX">
...
<div class="right">
  ...
  <a href="/brochure/ix" class="btn-bro">
  ...
  <!-- <a href="#" class="btn-bro" onclick="window.location.href='/shop'"> Buy Now  </a> -->
...
function changeCar(color){
    ...
    if(color === 'black'){
        ...
        currentImages = [
          "{{ asset('images/ixblack1.png') }}",
          "{{ asset('images/ixblack2.png') }}",
          "{{ asset('images/ixblack3.png') }}"
        ];
    ...
    if(color === 'blue'){
        ...
        currentImages = [
          "{{ asset('images/ixblue1.png') }}",
          "{{ asset('images/ixblue2.png') }}",
          "{{ asset('images/ixblue3.png') }}"
        ];
