...
<div class="detail-wrap">
    ...
    <div class="detail-grid">
        <div>
            <img id="mainImg" class="img-main" src="https://images.unsplash.com/photo-1507679799987-c73779587ccf?w=800" alt="Watch">
            <div class="thumb-row" id="thumbRow"></div>
        </div>
        <div>
            <span class="badge-cat">Accessories</span>
            <h1 class="prod-name">Watch</h1>
            <p class="prod-desc">Jam tangan premium dengan desain elegan dan mekanisme presisi tinggi. Terbuat dari stainless steel berkualitas tinggi untuk tampilan formal maupun casual.</p>
            <div class="prod-price">250.000</div>
            <div class="spec-box">
                <div class="spec-row"><span>Brand</span><span>BMW Collection</span></div>
                <div class="spec-row"><span>Material</span><span>Stainless Steel</span></div>
                <div class="spec-row"><span>Kondisi</span><span>Baru</span></div>
                <div class="spec-row"><span>Garansi</span><span>2 Tahun</span></div>
            </div>
            <a href="/beli?model=Watch&harga=250.000&skip=1" class="btn-beli">Beli Sekarang</a>
        </div>
    </div>
</div>
