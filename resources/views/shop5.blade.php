...
<section class="booking-section">
    ...
    <div class="booking-left">
        ...
        <div class="car-viewer">
            ...
            <img id="mainCar" src="{{ asset('images/i43.png') }}" alt="">
        ...
        <div class="thumb-gallery">
            <img class="thumb active"src="{{ asset('images/i43.png') }}"onclick="changeImage(0)">
            <img class="thumb"src="{{ asset('images/i42.png') }}"onclick="changeImage(1)">
            <img class="thumb"src="{{ asset('images/i41.png') }}"onclick="changeImage(2)">
    ...
    <div class="booking-right">
        ...
        <a href="#" class="book-btn" onclick="window.location.href='/beli?model=BMW+i4&harga=Rp+2.935.000.000'">
            Buy Now
        </a>
...
const images = [
    "{{ asset('images/i43.png') }}",
    "{{ asset('images/i42.png') }}",
    "{{ asset('images/i41.png') }}",
