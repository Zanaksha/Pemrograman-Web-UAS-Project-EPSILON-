...
<section class="booking-section">
    ...
    <div class="booking-left">
        ...
        <div class="car-viewer">
            ...
            <img id="mainCar" src="{{ asset('images/xmblue1.png') }}" alt="">
        ...
        <div class="thumb-gallery">
            <img class="thumb active"src="{{ asset('images/xmblue1.png') }}"onclick="changeImage(0)">
            <img class="thumb"src="{{ asset('images/xmblue2.png') }}"onclick="changeImage(1)">
            <img class="thumb"src="{{ asset('images/xmblue3.png') }}"onclick="changeImage(2)">
    ...
    <div class="booking-right">
        ...
        <a href="#" class="book-btn" onclick="window.location.href='/beli?model=BMW+XM&harga=Rp+935.000.000'">
            Buy Now
        </a>
...
const images = [
    "{{ asset('images/xmblue1.png') }}",
    "{{ asset('images/xmblue2.png') }}",
    "{{ asset('images/xmblue3.png') }}",
