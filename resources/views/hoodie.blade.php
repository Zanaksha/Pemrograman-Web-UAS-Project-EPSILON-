...
<div class="detail-wrap">
    ...
    <div class="detail-grid">
        <div>
            <img id="mainImg" class="img-main" src="https://images.unsplash.com/photo-1523381210434-271e8be1f52b?w=800" alt="Hoodie">
            <div class="thumb-row" id="thumbRow"></div>
        </div>
        <div>
            <span class="badge-cat">Clothing</span>
            <h1 class="prod-name">Hoodie</h1>
            <p class="prod-desc">Hoodie premium dengan bahan cotton fleece lembut dan hangat. Desain minimalis dan modern cocok untuk tampilan casual sehari-hari.</p>
            <div class="prod-price">90.000</div>
            <div class="spec-box">
                <div class="spec-row"><span>Brand</span><span>BMW Lifestyle</span></div>
                <div class="spec-row"><span>Material</span><span>Cotton Fleece</span></div>
                <div class="spec-row"><span>Kondisi</span><span>Baru</span></div>
                <div class="spec-row"><span>Garansi</span><span>3 Bulan</span></div>
            </div>
            <p class="size-label">Pilih Ukuran:</p>
            <div class="size-opts" id="sizeOpts"></div>
            <a href="/beli?model=Hoodie&harga=90.000&skip=1" class="btn-beli">Beli Sekarang</a>
        </div>
    </div>
</div>
