...
<section class="booking-section">
    ...
    <div class="booking-left">
        ...
        <div class="car-viewer">
            ...
            <img id="mainCar" src="{{ asset('images/ix3.png') }}" alt="">
        ...
        <div class="thumb-gallery">
            <img class="thumb active"src="{{ asset('images/ix3.png') }}"onclick="changeImage(0)">
            <img class="thumb"src="{{ asset('images/ix1.png') }}"onclick="changeImage(1)">
            <img class="thumb"src="{{ asset('images/ix2.png') }}"onclick="changeImage(2)">
    ...
    <div class="booking-right">
        ...
        <a href="#" class="book-btn" onclick="window.location.href='/beli?model=BMW+ix&harga=Rp+935.000.000'">
            Buy Now
        </a>
        ...
        <div class="contact-box">
            ...
            <p>
                Stay informed on our exclusive news and offers.
            </p>
...
const images = [
    "{{ asset('images/ix3.png') }}",
    "{{ asset('images/ix1.png') }}",
    "{{ asset('images/ix2.png') }}",
