...
<div class="sidebar">
    ...
    <a href="/admin/products" class="active"><i class="bi bi-bag me-2"></i> Manage Products</a>
       ...
       <form method="POST" action="{{ route('admin.products.store') }}" enctype="multipart/form-data">
            ...
            <div class="row g-3">
                ...
                <div class="col-12">
                    ...
                    <input type="text" name="sizes" class="form-control" value="{{ old('sizes') }}" placeholder="Kosongkan jika tidak ada ukuran">
                </div>
                <div class="col-12">
